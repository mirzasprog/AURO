...
import { PDFRedovniOtpis } from "../data/pdf-redovni-otpis";
...
export class ExportRedovniOtpisService {
  readonly LOGO =
  ...
  printRedovniOtpisPDF(podaci: PDFRedovniOtpis[], ukupnaVrijednost: number, brojOtpisa: string) {
...

        {
          ...
          table: {
            ...
            body: [
              [
                {
                  text: "Podaci o najavljenom redovnom otpisu i artiklima za otpis ",
                  bold: true,
                  colSpan: 9,
                  alignment: "center",
                  fontSize: 16,
    ...
    /**    {
          columns: [
            ...
            [
              ...
              {
                text: "(ime i prezime potpis)",
                alignment: "center",
              },
            ],

            { width: "25%", margin: [80, 65], text: "M.P." },

            [
              {
                width: "25%",
                margin: [30, 25, 0, 0],
                text: "Otpis odobrio - područni voditelj:",
              },
              {
                width: "25%",
                margin: [15, 50, 0, 0],
...
*/
  ...
  generisiStavke(): Array<any> {
    ...
    for (let s of this.stavke) {
      ...
      ispisStavke.push({ text: s.provedenoSnizenje, alignment: "center" });
      ...
      ispisStavke.push({ text: s.nabavnaVrijednost, alignment: "center" });
      ispisStavke.push({ text: s.ukupnaVrijednost, alignment: "center" });

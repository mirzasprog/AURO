...
@Component({
  selector: 'ngx-artikli-vanredni',
  templateUrl: './artikli-vanredni.component.html',
  styleUrls: ['./artikli-vanredni.component.scss']
})
export class ArtikliVanredniComponent implements OnInit {
  settings = {
    actions: {
      add: false,
      edit:false,
  ...
  ngOnInit(): void {
    this.dataService.prikaziDetaljeVanrednogOtpisaPodneseno(this.brojOtpisa).subscribe(
      (r) => {
        this.data = r;
